...
class WebGuiTests(unittest.TestCase):
    ...
    def test_web_ui_does_not_poll_backend_state(self) -> None:
        ...
        self.assertIn("xsheet-remapで「CSP自動登録データを書き出す」を実行します", HTML)
        ...
        self.assertIn("自動登録先のCLIPファイルを確認", HTML)
