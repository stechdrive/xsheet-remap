    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { term: '中央：タイムシート', description: 'ACTION、CELL、SOUND、CAMERAの各欄へ入力します。上のツールバーでテンプレート、兼用カット、ページ、倍率、注釈を操作します。' },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: '兼用カットと修正シート',
        items: [
          { term: '兼用カット', description: '上部の「兼用」メニューを開き、一覧からの切替、追加、現在のカットの削除を行います。登録セルと素材を共有しながら、タイミング、メモ、紙シート画像、修正履歴はカットごとに管理されます。' },
          { term: '兼用番号の表示', description: '同じ「兼用」メニューの「シートに兼用カット番号を表示」をオンにすると、同じグループのほかのカット番号をシートと画像出力へ表示します。最後に残った1カットは削除できません。' },
