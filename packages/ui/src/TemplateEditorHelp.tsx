    ...
    sections: [
      {
        title: '4種類の役割',
        items: [
          { term: 'ACTION', description: '原画工程で、原画番号と中割りのタイミング指示を記入する欄です。偶数フレームのカウンターを右端に表示し、トラック構成に連動します。' },
          { term: 'SOUND', description: '台詞やSEなどの音響指示を、開始から終了までの区間として記入する欄です。列数は「領域一覧」から変更できます。' },
          { term: 'CELL', description: '動画工程で、動画番号とそのタイミングを記入する欄です。秒カウンターは左側に表示されます。デジタルではCELLトラック数に連動します。' },
          { term: 'CAMERA', description: 'カメラワークや撮影指示を、指定フレームの区間に記入する欄です。デジタルでもSOUNDと同様にレーン数に合わせて横方向へ増やせます。' },
        ],
      },
      {
        title: '行・列・開始フレーム',
