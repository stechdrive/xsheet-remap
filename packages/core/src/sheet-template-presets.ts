...
const fixedLogicalTimelineLaneProjection: SheetTemplateTrackProjection = {
  source: 'logical-timeline-lanes',
  startIndex: 0,
  overflow: 'hidden',
}
  ...
  auxiliaryBands: [
    {
      ...
      slotRegionIds: ['left_action_reserve_grid', 'left_action_grid', 'left_sound_grid', 'left_cell_grid', 'left_camera_grid'],
    },
    {
      bandId: 'right_timing_band',
      anchorRegionIds: ['right_action_grid', 'right_cell_grid'],
      slotRegionIds: ['right_action_reserve_grid', 'right_action_grid', 'right_sound_grid', 'right_cell_grid', 'right_camera_grid'],
    },
  ],
  fields: [
  ...
  regions: [
    {
      ...
      form: {
        ...
        cells: [
          ...
          formLabelCell('process_label_direction_final', 0, 9, '演出'),
          formLabelCell('process_label_supervision_final', 0, 10, '監督'),
          formLabelCell('process_label_animation_director_final', 0, 11, '作監'),
          formLabelCell('process_label_chief_animation_director_final', 0, 12, '総作監'),
          ...
          formFieldCell('process_field_direction_final', 1, 9, 'process.direction.final'),
          formFieldCell('process_field_supervision_final', 1, 10, 'process.supervision.final'),
          formFieldCell('process_field_animation_director_final', 1, 11, 'process.animationDirector.final'),
          formFieldCell('process_field_chief_animation_director_final', 1, 12, 'process.chiefAnimationDirector.final'),
...
const digitalLogicalTimelineLaneProjection: SheetTemplateTrackProjection = {
  source: 'logical-timeline-lanes',
  startIndex: 0,
  overflow: 'scroll',
}
...
export const digitalStandardSheetTemplate: SheetTemplate = {
  ...
  auxiliaryBands: [
    {
      ...
      slotRegionIds: ['digital_action_grid', 'digital_sound_grid', 'digital_cell_grid', 'digital_camera_grid'],
    },
  ],
  horizontalFlow: {
  ...
  regions: [
    ...
    },
    {
      ...
      form: {
        columns: [DIGITAL_STANDARD_CONTENT_WIDTH_PX],
        rows: [32, 268],
        borderStyle: STANDARD_A3_FORM_BORDER,
        cells: [
    ...
    },
    {
      ...
      grid: { role: 'action', frameStart: 1, rowCount: 144, majorLineEvery: 6, pageBreakEvery: 24, rowLineRules: STANDARD_24_FPS_ROW_LINE_RULES, trackProjection: digitalLogicalPaperTrackProjection, frameProjection: digitalLogicalFrameProjection, columnSizing: { mode: 'fixed-content', defaultWidthPx: 420 / digitalActionColumns.length }, typography: DIGITAL_STANDARD_TIMING_GRID_TYPOGRAPHY, columns: digitalActionColumns },
    },
    {
      regionId: 'digital_sound_grid',
      type: 'exposure-grid',
      label: 'SOUND',
      rect: digitalRect(508, DIGITAL_STANDARD_GRID_TOP_PX, 220, DIGITAL_STANDARD_GRID_HEIGHT_PX),
      usage: 'input',
      inputKind: 'dialogue',
      inputMode: 'timed-range',
    ...
    },
    {
      ...
      type: 'exposure-grid',
      label: 'CELL',
      rect: digitalRect(736, DIGITAL_STANDARD_GRID_TOP_PX, 800, DIGITAL_STANDARD_GRID_HEIGHT_PX),
      usage: 'input',
      inputKind: 'timing-event',
      inputMode: 'point-event',
      flowGroupId: 'digital_cell',
      grid: { role: 'cell', frameStart: 1, rowCount: 144, majorLineEvery: 6, pageBreakEvery: 24, rowLineRules: STANDARD_24_FPS_ROW_LINE_RULES, trackProjection: digitalLogicalPaperTrackProjection, frameProjection: digitalLogicalFrameProjection, columnSizing: { mode: 'fixed-content', defaultWidthPx: 800 / digitalCellColumns.length }, typography: DIGITAL_STANDARD_TIMING_GRID_TYPOGRAPHY, columns: digitalCellColumns },
    },
    {
