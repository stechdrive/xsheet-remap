...
describe('CameraCueLayer', () => {
  ...
  it('renders all four semantic instruction shapes and an editable overlap pivot', () => {
    ...
    expect(container.querySelectorAll('.cameraCue[data-sheet-touch-interaction="direct"]')).toHaveLength(0)
    expect(container.querySelectorAll('.cameraCueLabel[data-sheet-touch-interaction="direct"]')).toHaveLength(0)
    expect(container.querySelectorAll('.cameraCuePoint.movable[data-sheet-touch-interaction="direct"]')).toHaveLength(0)
    expect(container.querySelectorAll('.cameraCuePivotHandle[data-sheet-touch-interaction="direct"]')).toHaveLength(1)
    expect(container.querySelectorAll('.cameraCueLabelResizeHandle[data-sheet-touch-interaction="direct"]')).toHaveLength(1)
