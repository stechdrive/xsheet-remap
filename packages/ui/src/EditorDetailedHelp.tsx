  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: 'ページ注釈',
        items: [
          { term: 'ペン', description: 'Pキーまたはペンボタンで開始し、ペンまたはマウスでシート上をドラッグして描きます。指ドラッグは表示移動になるため、ペン入力中もシートをスクロールできます。色と線幅を選べます。' },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { term: '指ドラッグ／Space+ドラッグ／中ボタン', description: 'シート表示の移動。指を動かさずタップするとセルを選択します。Ctrl+ホイールで拡大縮小、Shift+ホイールで横スクロール。' },
        ],
      },
      {
        title: '確認ポイント',
