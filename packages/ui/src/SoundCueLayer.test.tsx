...
describe('SoundCueLayer', () => {
  ...
  it('colors adjacent SOUND columns while keeping every cue in one column stable', () => {
    ...
    expect(container.querySelectorAll('.soundCue[data-sheet-touch-interaction="direct"]')).toHaveLength(0)
    expect(container.querySelectorAll('.soundCueEdgeHandle[data-sheet-touch-interaction="direct"]')).toHaveLength(0)
