...
import { verifyTimingEditingScenario } from './scenarios/timing-editing'
  ...
  switch (scenario) {
    ...
    case 'timing-edit':
      await verifyTimingEditingScenario({
        clickFrame, rightClickFrame, dragRange, waitForSelectedRange, waitForSelectedFrame, waitForEventAt,
        waitForNoEventAt, keyPress, keyboardShortcut, clickMenuItem, waitForPageCondition, waitForSelectedRangeTracks,
        dragRangeBetweenTracks, dragTimelineEvent,
      }, checks)
      return
    case 'asset-drop':
