  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        title: '兼用カットと修正シート',
        items: [
          { term: '兼用カット', description: '上部の「兼用」メニューを開き、一覧から切り替えます。＋を押すと追加する兼用カット名を入力でき、チェックまたはEnterで作成します。名前は番号以外も使用できます。登録セルと素材を共有しながら、タイミング、メモ、紙シート画像、修正履歴はカットごとに管理されます。' },
