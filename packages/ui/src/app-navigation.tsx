...
function EditorHelpContent() {
  return <>
    <article className="appHelpWorkflow">
      ...
      <p>カット情報と尺を設定し、ACTION、CELL、CAMERA、SOUNDの各欄へタイミングを入力します。Editor下部では3トラックのセリフ音声を録音・範囲編集し、カット頭または再生ヘッドから「間」を含めて通し確認できます。検出した発話候補からSOUNDを直接作成できます。ACTIONとCELLは同じ論理セル列を共有します。</p>
      <ol>
